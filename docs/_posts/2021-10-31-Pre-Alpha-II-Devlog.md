...
<table>
    <tbody>
        ...
        <tr>
            ...
            <br/>
            I then moved all of my code to a new, dedicated script (it had previously been living in the AmmoUIManager script), cleaned up the code, and submitted another pull request.<br/>
            <br/>
            <img src="/resources/crosshair_change_demonstration.gif" alt="Demonstration of changing crosshairs"/></td>
        </tr>
        <tr></tr>
        <tr>
            <td>1 hr. 35 min.</td>
        ...
        <tr>
            <td>10/31</td>
            <td>1 hr. 50 min.</td>
            <td>Studio meeting. During pair playtesting, the person playtesting Bloom remarked that it was too difficult, which was interesting because one of the primary issues that we want to fix in the game is its low-to-the-point-of-boredom difficulty level.<br/>
            <br/>
            During the programming team meeting, the design lead informed me that he had re-written part of my tri-shot re-re-design. Among other things, he changed the hitscan variant's firing mode so that it projected a cone in front of the player, which would damage all enemies that it made contact with equally, instead of sticking with a traditional shotgun approach. I pushed back on this idea quite a bit, since I thought that it would be difficult to communicate visually, wouldn't be intuitive to the player, and wouldn't allow for variable damage based on number of shots that connect with an enemy, and I was eventually able to convince him. I then spoke with him later about his changes to the projectile variant of the weapon, which he entirely re-designed into a weapon with no spread or charge ability, an added bullet bouncing component, and dual firing modes. I thought that this version of the weapon didn't accomplish what we wanted it to accomplish (which was to be a heavier-hitting weapon with longer reload times), and I was able to convince him of the same. He agreed to revert this weapon to my original design.</td>
        </tr>
        <tr>
            <td><b>Total:</b></td>
            <td colspan="2"><b>19 hr. 55 min.</b></td>
        </tr>
    </tbody>
</table>